                            ...
                            <div class="col-md-7">
                                ...
                                <div class="card strpied-tabled-with-hover">
                                    <div class="card-header ">
                                        <center><h4 class="card-title">Enter the Access Key</h4></center><br><br>
                                    </div>
                                    <%
                                    ...
                                    %>
                                    <div class="card-body">
                                        <form action="view_requested1.jsp" method="post">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" name="access_key" autocomplete="off" placeholder="Acess Key">           
                                                    </div>	
                                                </div>
                                                <div class="form-group">
                                                    <button type="submit" class="btn btn-primary btn-fill">Verify</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
