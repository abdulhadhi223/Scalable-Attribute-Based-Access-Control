                            ...
                            <div class="col-md-6">
                                ...
                                <div class="card ">
                                    <div class="card-header ">
                                        <center> <h3 class="card-title">Domain Authority</h3></center><br><br>
                                    </div>
                                    <div class="card-body">
                                        <form method="post" action="domain_login">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label><b>Email ID :</b></label><br>
                                                        <input type="text" name="name" class="form-control" placeholder="Enater Your Email ID" required="required">
                                                    </div>
                                                    <div class="form-group">
