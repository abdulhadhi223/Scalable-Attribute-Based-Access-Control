                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card strpied-tabled-with-hover">
                                    <div class="card-header ">
                                        <center><h4 class="card-title">Cloud Files</h4></center>
                                    </div>
                                    <div class="card-body table-full-width table-responsive">
                                        <table class="table table-hover">
                                            <thead>
                                            <td class="text-center"><b>Data Owner Name</b></td>
                                            <td class="text-center"><b>File ID</b></td>
                                            <td class="text-center"><b>File Name</b></td>
                                            <td class="text-center"><b>Uploaded Time</b></td>
                                            <td class="text-center"><b>File Policy</b></td>
                                            <td class="text-center"><b>D KEY</b></td>
                                            </thead>
                                            <%
