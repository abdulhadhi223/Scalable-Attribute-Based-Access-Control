                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card strpied-tabled-with-hover">
                                    <div class="card-header ">
                                        <center><h4 class="card-title">Access Files</h4></center>
                                    </div>
                                    <div class="card-body table-full-width table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            <td class="text-center"><b>Access Policy</b></td>
                                            ...
                                            <%
                                                ...
                                                try {
                                                    ResultSet rs = st.executeQuery("Select * from do_files where policy  ='" + role + "' ");
                                                    while (rs.next()) {
                                            %>
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="center"><%=rs.getString("policy")%> </td>
