                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card strpied-tabled-with-hover">
                                    <div class="card-header ">
                                        <center><h4 class="card-title">File Access Report</h4></center>
                                    </div>
                                    <div class="card-body table-full-width table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            <td class="text-center"><b>Downloaded Time</b></td>
                                            </thead>
                                            <%
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="center"><%=rs.getString("fileid")%> </td>
                                                    <td class="center"><%=rs.getString("filename")%> </td>
                                                    <td class="center"><%=rs.getString("uname")%> </td>
