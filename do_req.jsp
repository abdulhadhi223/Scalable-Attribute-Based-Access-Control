        ...
        <div class="wrapper">
            ...
            Tip 2: you can also add an image using data-image tag
                ...
                <div class="sidebar-wrapper">
                    ...
                    <ul class="nav">
                        <li>
                            <a class="nav-link" href="Domain_Home.jsp">
                                <i class="nc-icon nc-app"></i>
                                <p>Home</p>
                            </a>
                        </li>
                        <li class="nav-item active">
                            <a class="nav-link" href="do_req.jsp">
                                <i class="nc-icon nc-layers-3"></i>
                                <p>Data Owners</p>
                            </a>
                        </li>
                        <li>
                            <a class="nav-link" href="du_req.jsp">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card strpied-tabled-with-hover">
                                    <div class="card-header ">
                                        <center><h4 class="card-title">Data Owner Request</h4></center>
                                    </div>
                                    <div class="card-body table-full-width table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                            <form action="do_approve.jsp" method="get">
                                                ...
                                                <td><i><button type="submit" class="btn btn-success btn-fill btn-circle fa fa-check" style="color: white ; width: 40px; height: 40px"></button></i> &nbsp;&nbsp;
                                            </form> 
                                            </tr> 
                                            </tbody>
                                            <%                                        }
